                                           ...
                                           at::Tensor& alibi)
{
    ...
    auto prev_key = torch::from_blob(workspace + offset,
                                     ...
                                     {long(hidden_dim * InferenceContext::Instance().GetMaxTokenLength()),
                                      long(k * InferenceContext::Instance().GetMaxTokenLength()),
                                      k,
                                      1},
                                     options);
                                        ...
                                        bool transposed_mode)
{
    ...
    auto intermediate_gemm =
        at::from_blob(intermediate_ptr, {input.size(0), input.size(1), long(mlp_1_out_neurons)}, options);
